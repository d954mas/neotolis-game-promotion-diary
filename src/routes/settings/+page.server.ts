 ...
 * /settings loader.
 *
 * Surfaces user / theme / retentionDays from the layout pass-through plus
 * the active-sessions list and the current-session id so the SessionsList
 ...
 * this loader fetches sessions via the service layer (tenant scope)
